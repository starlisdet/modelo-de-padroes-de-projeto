...
public class Demo { // demo da aplicação
	private static Application configureApplication() { // método privado e estático para configurar aplicação
		...
		// pega as propriedades da string osName para verificar se os parâmetros correspondem ao argumento especificado (vale ressaltar a formatação para lowercase)
